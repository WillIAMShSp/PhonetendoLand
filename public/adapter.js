            ...
            window.RTCPeerConnection.prototype.removeTrack =
              function removeTrack(sender) {
                ...
                Object.keys(this._streams).forEach(function (streamid) {
                  var hasTrack = _this12._streams[streamid]
                    .getTracks()
                    .find(function (track) {
          ...
          function shimRTCIceCandidate(window) {
            ...
            window.RTCIceCandidate = function RTCIceCandidate(args) {
              ...
              if (args.candidate && args.candidate.length) {
                ...
                var parsedCandidate = _sdp["default"].parseCandidate(
                  args.candidate,
                );
      ...
      10: [
        function (require, module, exports) {
          ...
          function wrapPeerConnectionEvent(window, eventNameToWrap, wrapper) {
            ...
            var addEventListener = Object.getOwnPropertyDescriptor(
          ...
          function detectBrowser(window) {
            ...
            if (navigator.userAgentData && navigator.userAgentData.brands) {
              var chromium = navigator.userAgentData.brands.find(
                function (brand) {
            ...
            if (navigator.mozGetUserMedia) {
              ...
              result.version = parseInt(
                extractVersion(navigator.userAgent, /Firefox\/(\d+)\./, 1),
              );
            } else if (
              ...
              result.version = parseInt(
                extractVersion(navigator.userAgent, /AppleWebKit\/(\d+)\./, 1),
              );
